...
void fdct_8x8(DCTVAL *in)//BLOCK,一个MCU,进行DCT变换 
{
  float c1 = 0.9808;
  float c2 = 0.9239;
  float c3 = 0.8315;
  ...
  for (row=0; row<DCTSIZE; row++) 
  {
    ...
    data[0] =(DCTVAL)(c4 * (s0734 + s1625));
    data[1] =(DCTVAL)(c1*d07 + c3*d16 + c5*d25 + c7*d34);
    data[2] =(DCTVAL)(c2*d0734 + c6*d1625);
    data[3] =(DCTVAL)(c3*d07 - c7*d16 - c1*d25 - c5*d34);
    data[4] =(DCTVAL)(c4 * (s0734 - s1625));
    data[5] =(DCTVAL)(c5*d07 - c1*d16 + c7*d25 + c3*d34);
    data[6] =(DCTVAL)(c6*d0734 - c2*d1625);
    data[7] =(DCTVAL)(c7*d07 - c5*d16 + c3*d25 - c1*d34);
  ...
  for (col=0; col<DCTSIZE; col++) 
  {
    ...
    *tdata[0] = (DCTVAL)(c4 * (s0734 + s1625));
    *tdata[1] = (DCTVAL)(c1*d07 + c3*d16 + c5*d25 + c7*d34);
    *tdata[2] = (DCTVAL)(c2*d0734 + c6*d1625);
    *tdata[3] = (DCTVAL)(c3*d07 - c7*d16 - c1*d25 - c5*d34);
    *tdata[4] = (DCTVAL)(c4 * (s0734 - s1625));
    *tdata[5] = (DCTVAL)(c5*d07 - c1*d16 + c7*d25 + c3*d34);
    *tdata[6] = (DCTVAL)(c6*d0734 - c2*d1625);
    *tdata[7] = (DCTVAL)(c7*d07 - c5*d16 + c3*d25 - c1*d34);
